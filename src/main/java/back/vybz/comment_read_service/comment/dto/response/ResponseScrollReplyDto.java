...
@Getter
@NoArgsConstructor
public class ResponseScrollReplyDto {
    ...
    @Builder
    public ResponseScrollReplyDto(List<ResponseScrollCommentVo> content,
                                  boolean hasNext,
    ...
    public static ResponseScrollReplyDto from(CursorPage<CommentRead> cursorPage) {
        return ResponseScrollReplyDto.builder()
